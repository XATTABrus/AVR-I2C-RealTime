/*
Данная библиотека использует функции из библиотеки TWI.h 
т.к переходник общается с МК используя модуль TWI(I2C)
 */
